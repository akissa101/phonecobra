...
const LoginModal = ({
  ...
  return (
    <Dialog onOpenChange={setIsOpen} open={isOpen}>
      <DialogContent className="absolute z-[9999999] bg-slate-50 dark:bg-slate-800 border-slate-300 dark:border-slate-700">
        <DialogHeader>
        ...
        <div className="grid grid-cols-2 gap-6 divide-x divide-gray-200 dark:divide-gray-700">
