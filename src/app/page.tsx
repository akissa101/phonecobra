          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t via-slate-800/50 from-slate-800 h-28" />
                <Image
                  src="/snake-1.png"
                  alt="sname"
                  width={200}
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-20 font-bold !leading-tight text-5xl md:text-6xl lg:text-7xl">
                Your Image on a{' '}
